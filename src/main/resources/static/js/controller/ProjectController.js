class ProjectController{
    ...
    loadProjects(){
        ...
        jQuery.get( "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/events", function( data ) {
            console.log(data);
    ...
    async abrirModal(id){
        ...
        if(id != null){
            await jQuery.get( "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/event/"+id, function( data ) {
                self.fillForm(data);
            });
        }
    ...
    fillTargetAudiences(){
        var self = this;
        jQuery.get( "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/targetAudiences/", function( data ) {
    ...
    fillCategories(){
        var self = this;
        jQuery.get( "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/categories/", function( data ) {
    ...
    saveEvent(){
        ...
        jQuery.ajax({
            type: 'POST',
            url : "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/event",
    ...
    deleteProject(id){
        ...
        jQuery.ajax({
            type: 'DELETE',
            url : "https://cors-anywhere.herokuapp.com/https://solidarizr-manager.herokuapp.com/event/"+id,
